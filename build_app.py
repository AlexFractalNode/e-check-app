...
{{
    ...
    "icons": [
        {{
            "src": "https://img.icons8.com/color/192/organic-food.png",
            "sizes": "192x192",
            "type": "image/png"
        }},
        {{
...
<script>
    ...
    async function analyzeProduct(barcode) {{
        ...
        try {{
            ...
            if (data.status === 0) {{
                content.innerHTML = `<h2>🤷‍♂️ Unbekannt</h2><p>Barcode ${{barcode}} nicht gefunden.</p>`;
                return;
            }}
...
# 3. DATEIEN SCHREIBEN
print(f"🏗️ Erstelle {OUTPUT_MANIFEST}...")
with open(OUTPUT_MANIFEST, "w", encoding="utf-8") as f:
    f.write(manifest_content)

print(f"🏗️ Erstelle {OUTPUT_HTML} (Final Version)...")
with open(OUTPUT_HTML, "w", encoding="utf-8") as f:
    f.write(html_content)

print("✅ Fertig! App ist bereit.")
